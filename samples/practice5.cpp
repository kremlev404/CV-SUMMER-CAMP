...
public:
	...
	TrackedObjects detect(const cv::Mat& frame, int frame_idx)
	{
		...
		for (int i = 0; i < detection_as_mat.rows; i++)
		{
			...
			Classificator* dnnClassificator = new DnnClassificator(modelPath, configPath, labelsPath, 227, 227, Scalar ( 104.0,117.0,133.0 ), false);
...
int main(int argc, char** argv) {
	...
	detector_weights = "C:/Users/temp2019/Desktop/CV-SUMMER-CAMP-build/mobilenet-ssd.caffemodel";
	 modelPath = "C:/Users/temp2019/Desktop/CV-SUMMER-CAMP-build/classification/squeezenet/1.1/caffe/squeezenet1.1.caffemodel";
	 configPath = "C:/Users/temp2019/Desktop/CV-SUMMER-CAMP-build/classification/squeezenet/1.1/caffe/squeezenet1.1.prototxt";
	 labelsPath = "C:/Users/temp2019/Desktop/CV-SUMMER-CAMP/data/squeezenet1.1.labels";
	...
	for (;; )
	{
		...
		for (const auto &detection : tracker->trackedDetections()) {
			...
			if ((detection.class_id_21 == 12) && (detection.saved = false) && (detection.object_id != -1)) {
				string path = "C:/Users/temp2019/Desktop/CV-SUMMER-CAMP/data/" + to_string(detection.object_id) + "_" + lab[detection.class_id] + ".jpg";
			...
			Mat image(frame, detection.rect);
			
			// Classifificator
			Classificator* cl = new DnnClassificator(modelPath, configPath, labelsPath, 300, 300, { 104.0, 117.0, 123.0 }, false);
			...
			int classId = classIdPoint.x;
			// TEXT
			std::string text = std::to_string(detection.object_id) + (lab[classId - 1]) +
